semaine = [{ :GOO => 15, :MMM => 14, :ADBE => 12, :EA=> 13, :BA => 8, :KO => 10, :XOM => 20, :GPS => 7, :MCD => 11, :DIS => 15, :CRM => 6, :JNJ => 10 },
...
def trader_du_lundi(semain)
  tablo = []
  semain_name = semain.flat_map {|jour| jour.keys}.uniq
  tableord = semain_name.map {|name| semain.map {|jour| jour[name]}} 
tablo << tableord
puts tablo.join
end

trader_du_lundi(semaine)